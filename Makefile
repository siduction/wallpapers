...
#SIZES= 1280x720 1280x800 1280x1024 \
...
#	$(RM) "build/${CODENAME_SAFE}/contents/screenshot.png"
	cp jpg/screenshot.jpg build/${CODENAME_SAFE}/contents/
...
images:
	...
	$(RM) build/${CODENAME_SAFE}/contents/images/*.jpg
#	inkscape --without-gui --export-width=$(firstword $(subst x, ,$@ )) \
#	    --export-height=$(lastword $(subst x, ,$@ )) \
...
#	$(RM) "build/${CODENAME_SAFE}/contents/images/$@.png"
	cp jpg/*.jpg build/${CODENAME_SAFE}/contents/images/
	$(RM) build/${CODENAME_SAFE}/contents/images/screenshot.jpg
